...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**usersGet**](doc//DefaultApi.md#usersget) | **GET** /users | Get a list of users
*DefaultApi* | [**usersIdGet**](doc//DefaultApi.md#usersidget) | **GET** /users/{id} | Get a user by ID
